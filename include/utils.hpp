...
bool two_opt_star_between_two_routes(int* route1, int* route2, int& length1, int& length2, int& loading1, int& loading2, double& cost, int* temp_r1, int* temp_r2, int node_cap, Case& instance);
...
void node_relocation_intra_for_individual(Individual& individual, Case& instance); // three-arcs exchange, intra-route
...
bool node_relocation_inter_for_individual(Individual& individual, Case& instance); // three-arcs exchange, inter-route
void node_exchange_for_single_route(int* route, int length, double& cost, Case& instance);
void node_exchange_intra_for_individual(Individual& individual, Case& instance); // four-arcs exchange, intra-route
...
bool node_exchange_inter_for_individual(Individual& individual, Case& instance); // four-arcs exchange, inter-route
// accelerated version
